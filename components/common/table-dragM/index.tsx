      ...
      {tableBody?.length > 0 ? (
        <>
          {tableBody.length > 0 || loading ? (
            <>
              <table className="shadow-lg w-full table-auto">
                <thead>
                  <tr className="">
                    <td className="bgmaincolor w-[50px] p-2 font-bold ">
                      {""}
                    </td>
                    {data?.table?.map((row: any, i: any) => (
                      <td
                        key={i}
                        className="bgmaincolor text-white p-2 font-bold "
                      >
                        {row.label}
                      </td>
                    ))}
                      ...
                      >
                        <td
                          className={`bg-gray-200 ${
                            index % 2 == 0 ? "" : ""
                          } p-2 focus:!bg-[#d4e4fc] hover:!bg-[#d4e4fc] border-white border-b-[5px]`}
                        >
                            ...
                            {isview ? (
                              <>
                                {/* <button
                                  ...
                                  onClick={() => {
                                    router.push(fullpath + "?data=" + row?.id);
                                  }}
                                >
