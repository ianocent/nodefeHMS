        ...
        >
          {!loading ? (
            <div className="table-responsive w-full">
              ...
              {/* 1. Kalo data kosong, tampilin tulisan ini di bawah header tabel */}
              ...
              {/* 2. Tombol Add SEKARANG BEBAS dari panjang data. Selama isAdd true, dia muncul! */}
              {isAdd && (
                <div className="flex w-full justify-center mt-2 pt-2 border-t">
                  <ButtonSubmit
                    label="Add"
                    onCreate={() => {
                      setpopup(true);
  ...
  const GetDataDetail = async () => {
    try {
      ...
      if (data?.code == "200") {
        ...
        obj.check_out_date = GetNextDay(data?.master?.business_date, 1);
        setData({ ...dataval, ...obj });
        setdataform([...dataInput]);
