...
const InvoiceView = () => {
  const FOLDER = "accounting/credit-note";
  const FOLDERUPDATESTATUS = "/cms/accounting/credit-note/update-status";
  ...
  const canProcess = useTransactionPermission("processed_creditNote");
  const canCancel = useTransactionPermission("cancel_creditNote");
