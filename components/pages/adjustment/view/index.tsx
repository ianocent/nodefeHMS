...
const InvoiceView = () => {
  const FOLDER = "accounting/adjustment";
  const FOLDERUPDATESTATUS = "/cms/accounting/adjustment/update-status";
  ...
  const canProcess = useTransactionPermission("processed_adjusment");
  const canCancel = useTransactionPermission("cancel_adjusment");
