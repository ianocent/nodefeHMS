...
const InvoiceView = () => {
  const FOLDER = "accounting/refund";
  const FOLDERUPDATESTATUS = "/cms/accounting/refund/update-status";
  ...
  const canProcess = useTransactionPermission("processed_refund");
  const canCancel = useTransactionPermission("cancel_refund");
