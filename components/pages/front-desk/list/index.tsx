...
const ListView = (props: ReservationFitprp) => {
  ...
  const changeHandler = (
    ...
    if (
      ...
      if (ismulti) {
        ...
        qStr = qStr + "&" + name + "=" + valarr.toString();
      } else {
      ...
      dataSet[name + "_ori"] = e;
      dataSet[name] = ismulti ? valarr : e?.value;
    } else if (b == "checkbox") {
      if (ismulti) {
    ...
    router.push({
      ...
      query: {
        ...
        search_field: GetQueryStr("search_field"),
        search_value: GetQueryStr("search_value"),
      },
    });
  };
  ...
  const GetDetailData = async (i: any, body) => {
    try {
            ...
            <div className="sm:grid grid-cols-12 h-fit gap-4 ml-2 mb-4 mr-2">
              <div className="col-span-12">
                <div className="sm:grid grid-cols-12 h-fit gap-4  mb-4 mt-4 mr-2">
                  ...
                  <div className="">
                    <ButtonSubmit label="Search" onCreate={() => {}} />
                  </div>
                </div> */}
                </div>
              </div>
