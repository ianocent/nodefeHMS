...
const InvoiceView = () => {
  const FOLDER = "accounting/payment";
  const FOLDERUPDATESTATUS = "/cms/accounting/payment/update-status";
  ...
  const {canCreate, canUpdate} = useFormPermission(1043);
  const canProcess = useTransactionPermission("processed_payment");
  const canCancel = useTransactionPermission("cancel_payment");
